...
public class Reviewer4 extends Agent {
    protected void setup(){
        System.out.println("Hello Reviewer4 " + getAID().getName() + " is ready.");

        // Available thesis proposals of the supervisor

        // Register agent to yellow pages
        String[] serviceTypes = {ServiceTypes.REVIEWER.toString(), "REVIEWER_COMPUTER_VISION"};
        String[] serviceNames = {"professor","professor_CV"};
